...
set xtics   (1.50000, 4.70000, 15.0000, 47.0000, 150.000)
...
set xlabel "link speed (Mbps)" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ 1.50000 : 150.000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "log(relative throughput / delay)" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ -3.00000 : -0.300000 ] noreverse nowriteback
...
GNUTERM = "wxt"
plot "./1xfinal.out" using 1:(5+log($2/$1)-log($4)) title "1x", "./10xfinal.out" using 1:(5+log($2/$1)-log($4)) title "10x", "./cubicsplice.out" using 1:(5+log($2/$1)-log($4)) title "Cubic" with lines, "./codelfinal.out" using 1:(5+log($2/$1)-log($4)) title "sfqCoDel"
#    EOF
