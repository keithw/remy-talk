...
\begin{itemize}
\item Link speed drawn uniformly on [10, 20] Mbps

\item RTT drawn uniformly on [100, 200] ms

\item $n$ drawn uniformly on [1, 16]

\item ``On'' distribution: exponential time, mean = 5 seconds

\item ``Off'' distribution: exponential time, mean = 5 seconds
